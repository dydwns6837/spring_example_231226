	...
	<div class="container">
		...
		<form method="post" action="/lesson06/ex01/add-user">
			...
			<div class="form-group">
				...
				<input type="text" id="yyyymmdd" name="yyyymmdd" class="form-control col-4" placeholder="예) 20000704">
			</div>
			<div class="form-group">
	...
	<script>
		$(document).ready(function() {
			...
			$("form").on('submit', function(e) {
				...
				if (name.length < 1) {
					alert("이름을 입력하시오.");
					return false; // submit 이벤트 일 때 false를 꼭 붙여야됨
				}
			...
			$("#joinBtn").on('click', function() {
				...
				if (name.length < 1) {
					alert("이름을 입력하시오.");
					return; // submit 이벤트 일 때 false를 꼭 붙여야됨
				}
